...
SET v_query = '''
    ...
    WHERE
        ...
        AND
        mr.MEINH = 'CS' AND mr.VOLEH != 'M3'AND (mr.VOLUM IS NOT NULL OR mr.VOLUM <> 0);
''';
...
SET v_details = CONCAT('Total: ', v_total, ', Failed: ', v_failed, ' Validamos el valor de la unidad del volumen de la umb2.');
...
SET file_name = CONCAT(
  'gs://maestromateriales-dataquality-pap/REGLA_DQ_77_MARA_',

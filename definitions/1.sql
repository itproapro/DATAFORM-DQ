...
-- DEFINIR LA REGLA ASIGNADA A v_query: Ejemplo, contar registros que son nulos en un campo
SET v_query = '''
   SELECT -- identificar materiales que no son únicos
...
SET v_status = CASE
    WHEN v_passed > 99.9  THEN 'PASSED'
    else 'FAILED'
END;
...
SET file_name = CONCAT(
  'gs://maestromateriales-dataquality-pap/REGLA_DQ_1_MARA_',

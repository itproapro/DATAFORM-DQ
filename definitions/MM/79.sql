...
-- DEFINIR LA REGLA ASIGNADA A v_query: -- Ancho 2-> comprobamos el valor de ancho 2 si UMB es distinta de CJ (MARM).
...
SET v_query = '''
    ...
    WHERE
        ...
        AND
        mr.MEINH = 'CS' AND (mr.BREIT IS NULL OR mr.BREIT = 0);
''';
...
SET v_details = CONCAT('Total: ', v_total, ', Failed: ', v_failed, ' Validamos el valor del ancho de la umb2.');
...
SET file_name = CONCAT(
  'gs://maestromateriales-dataquality-pap/REGLA_DQ_79_MARA_',

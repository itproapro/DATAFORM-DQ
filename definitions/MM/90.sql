...
-- DEFINIR LA REGLA ASIGNADA A v_query: -- Indicador para el control de precio, según el que se valora el stock de un material. Existen las siguientes opciones: estándar o variable. Control precios --> este campo debe ser un valor constante igual a 'V'.
...
SET v_details = CONCAT('Total: ', v_total, ', Failed: ', v_failed, ' Validamos el valor del campo control de precios.');
...
SET file_name = CONCAT(
  'gs://maestromateriales-dataquality-pap/REGLA_DQ_90_MARA_',

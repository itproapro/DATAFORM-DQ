...
-- DEFINIR LA REGLA ASIGNADA A v_query: -- Indicador que clasifica al material por su consumo en A, B o C siendo A de mayor consumo.
...
SET file_name = CONCAT(
  'gs://maestromateriales-dataquality-pap/REGLA_DQ_88_MARA_',

...
-- DEFINIR LA REGLA ASIGNADA A v_query: -- Cantidad Unidad de medida alternativa 4 --> el valor de este campo será siempre 1.
...
SET v_details = CONCAT('Total: ', v_total, ', Failed: ', v_failed, ' Validamos el valor de la unidad de medida alternativa 4 (PAL).');
...
SET file_name = CONCAT(
  'gs://maestromateriales-dataquality-pap/REGLA_DQ_83_MARA_',

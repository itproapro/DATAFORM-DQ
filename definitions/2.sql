...
-- DEFINIR LA REGLA ASIGNADA A v_query: TIPO DE PRODUCTO = A GENERAL
SET v_query = '''
...
SET v_details = CONCAT('Total: ', v_total, ', Failed: ', v_failed, '  Validación ramo tipo producto distinto a A');
...
SET file_name = CONCAT(
  'gs://maestromateriales-dataquality-pap/REGLA_DQ_2_MARA_',

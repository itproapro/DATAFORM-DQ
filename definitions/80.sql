...
-- DEFINIR LA REGLA ASIGNADA A v_query: -- Alto 2-> comprobamos el valor de alto 2 (MARM).
...
SET v_query = '''
    ...
    WHERE
        ...
        AND
        mr.MEINH = 'CS' AND (mr.HOEHE IS NULL OR mr.HOEHE = 0);
''';
...
SET v_details = CONCAT('Total: ', v_total, ', Failed: ', v_failed, ' Validamos el valor del alto de la umb2.');
...
SET file_name = CONCAT(
  'gs://maestromateriales-dataquality-pap/REGLA_DQ_80_MARA_',

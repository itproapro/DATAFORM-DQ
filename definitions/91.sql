...
-- DEFINIR LA REGLA ASIGNADA A v_query: -- Número de unidades de medida en que se basa el precio..
...
SET v_details = CONCAT('Total: ', v_total, ', Failed: ', v_failed, ' Validamos el valor de cantidad base según se basa el precio de valoración.');
...
SET file_name = CONCAT(
  'gs://maestromateriales-dataquality-pap/REGLA_DQ_91_MARA_',

...
-- DEFINIR LA REGLA ASIGNADA A v_query: -- Cantidad Unidad de medida alternativa 5 --> verificamos que el valor para CAP sea igual a 1.
...
SET v_details = CONCAT('Total: ', v_total, ', Failed: ', v_failed, ' Validamos el valor de la cantidad de unidad de medida alternativa 5 (CAP).');
...
SET file_name = CONCAT(
  'gs://maestromateriales-dataquality-pap/REGLA_DQ_86_MARA_',

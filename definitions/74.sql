...
-- DEFINIR LA REGLA ASIGNADA A v_query: Peso bruto umb 2 --> verificamos el peso de la caja cuando la UMB = UN.
...
SET v_query = '''
    ...
    WHERE
        ...
        AND m.MEINS='ST' AND mr.MEINH = 'CS' AND (ROUND(m.BRGEW*mr.UMREZ,3)) != ROUND(mr.BRGEW,3);
...
SET v_details = CONCAT('Total: ', v_total, ', Failed: ', v_failed, ' Validamos el valor del peso bruto de la umb2.');
...
SET file_name = CONCAT(
  'gs://maestromateriales-dataquality-pap/REGLA_DQ_74_MARA_',

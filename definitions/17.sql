...
-- DEFINIR LA REGLA ASIGNADA A v_query: Indicador material catch weight.
...
WHERE cwm_xcwmat = 'X' AND (cwm_tolgr IS NOT NULL OR cwm_tolgr != '');
''';
...
SET v_details = CONCAT('Total: ', v_total, ', Failed: ', v_failed, ' Validación material catch weight');
...
SET file_name = CONCAT(
  'gs://maestromateriales-dataquality-pap/REGLA_DQ_17_MARA_',
